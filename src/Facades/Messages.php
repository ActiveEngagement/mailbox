 ...
 * @method static void patch(\Actengage\Mailbox\Models\MailboxMessage $message)
 * @method static \Http\Promise\Promise<void> send(\Actengage\Mailbox\Models\MailboxMessage $message)
