...
return new class extends Migration
{
    ...
    {
        Schema::connection(config('mailbox.database_connection'))->create('mailbox_folders', function (Blueprint $table): void {
    ...
    {
        Schema::connection(config('mailbox.database_connection'))->dropIfExists('mailbox_folders');
    }
};
