...
return new class extends Migration
{
    ...
    {
        Schema::connection(config('mailbox.database_connection'))->create('mailbox_message_attachments', function (Blueprint $table): void {
            $table->id();
    ...
    {
        Schema::connection(config('mailbox.database_connection'))->dropIfExists('mailbox_message_attachments');
    }
};
